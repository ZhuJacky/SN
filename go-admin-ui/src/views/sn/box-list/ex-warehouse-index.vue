    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-table v-loading="loading" :data="boxList" border >
          ...
          <el-table-column label="出库时间" align="center" prop="updatedAt" width="155">
            <template slot-scope="scope">
...
<script>
import { listExWarehouseBox,doExWarehouseBox } from '@/api/sn/box-info'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listExWarehouseBox(this.queryParams).then(response => {
